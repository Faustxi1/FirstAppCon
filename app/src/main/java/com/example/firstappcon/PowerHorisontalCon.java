...
public class PowerHorisontalCon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_power_horisontal_con);
    ...
    public void resho(View view) {
        ...
        if (Q1.isEmpty() || kH1.isEmpty() || kv1.isEmpty() || kr1.isEmpty() || L.isEmpty() || v1.isEmpty() || KPD1.isEmpty()) {
            ...
            double Pokr = kd * L1 * w * (qr + qp + qp2 + 2 * ql) + qr;
            ...
            S1 = (S1 - Wsb + 0.04 * (S1 - Wsb) + Wgr) / snb1;
            S2 = S1 + Wsb;
            S3 = S1 + Wsb + 0.04 * (S1 - Wsb);
            S4 = S1 + Wsb + 0.04 * (S1 - Wsb) + Wgr;
    ...
    public void ClickClearHorisCon(View view) {
