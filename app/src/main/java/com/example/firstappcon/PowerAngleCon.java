...
public class PowerAngleCon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_power_angle_con);
    ...
    public void res(View view) {
        ...
        if (Q1.isEmpty() || kH1.isEmpty() || kv1.isEmpty() || kr1.isEmpty() || a1.isEmpty() || L.isEmpty() || v1.isEmpty() || KPD1.isEmpty()) {
            ...
            Lg = L1 * Math.cos(Math.toRadians(a));
            H = L1 * Math.sin(Math.toRadians(a));
    ...
    public void ClickClearangle(View view) {
